...
func (f *FinderBuilder) One(ctx context.Context) (*Account, error) {
...
func (f *FinderBuilder) All(ctx context.Context) ([]*Account, error) {
...
func (i *InsertBuilder) SetAccounts(u ...*Account) *InsertBuilder {
	for _, v := range u {
		i.a = append(i.a, v)
	}
	return i
