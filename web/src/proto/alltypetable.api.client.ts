...
/**
 * @generated from protobuf service example.AllTypeTableService
 */
export interface IAllTypeTableServiceClient {
    /**
     * @generated from protobuf rpc: CreateAllTypeTable(example.AllTypeTable) returns (example.AllTypeTable);
     */
    createAllTypeTable(input: AllTypeTable, options?: RpcOptions): UnaryCall<AllTypeTable, AllTypeTable>;
    /**
     * @generated from protobuf rpc: DeleteAllTypeTable(example.AllTypeTableId) returns (google.protobuf.Empty);
     */
    deleteAllTypeTable(input: AllTypeTableId, options?: RpcOptions): UnaryCall<AllTypeTableId, Empty>;
    /**
     * @generated from protobuf rpc: UpdateAllTypeTable(example.UpdateAllTypeTableReq) returns (example.AllTypeTable);
     */
    updateAllTypeTable(input: UpdateAllTypeTableReq, options?: RpcOptions): UnaryCall<UpdateAllTypeTableReq, AllTypeTable>;
    /**
     * @generated from protobuf rpc: GetAllTypeTable(example.AllTypeTableId) returns (example.AllTypeTable);
     */
    getAllTypeTable(input: AllTypeTableId, options?: RpcOptions): UnaryCall<AllTypeTableId, AllTypeTable>;
    /**
     * @generated from protobuf rpc: ListAllTypeTables(example.ListAllTypeTablesReq) returns (example.ListAllTypeTablesResp);
     */
