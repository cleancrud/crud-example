...
// @generated from protobuf file "proto/alltypetable.api.proto" (package "example", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message example.AllTypeTable
 */
...
/**
 * @generated from protobuf message example.AllTypeTableId
 */
...
/**
 * @generated from protobuf message example.UpdateAllTypeTableReq
 */
export interface UpdateAllTypeTableReq {
    /**
     * @generated from protobuf field: example.AllTypeTable all_type_table = 1;
     */
...
/**
 * @generated from protobuf message example.ListAllTypeTablesReq
 */
export interface ListAllTypeTablesReq {
     ...
     * order by field
     *
     * @generated from protobuf field: example.AllTypeTableField order_by_field = 3;
     */
     ...
     * filter
     *
     * @generated from protobuf field: repeated example.AllTypeTableFilter filters = 5;
     */
    filters: AllTypeTableFilter[]; // @gotags: form:"filters"
}
/**
 * @generated from protobuf message example.AllTypeTableFilter
 */
export interface AllTypeTableFilter {
    /**
     * @generated from protobuf field: example.AllTypeTableField field = 1;
     */
...
/**
 * @generated from protobuf message example.ListAllTypeTablesResp
 */
export interface ListAllTypeTablesResp {
    /**
     * @generated from protobuf field: repeated example.AllTypeTable all_type_tables = 1;
     */
...
/**
 * @generated from protobuf enum example.AllTypeTableField
 */
...
/**
 * @generated MessageType for protobuf message example.AllTypeTableId
 */
...
class UpdateAllTypeTableReq$Type extends MessageType<UpdateAllTypeTableReq> {
    constructor() {
        super("example.UpdateAllTypeTableReq", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: UpdateAllTypeTableReq): UpdateAllTypeTableReq {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* example.AllTypeTable all_type_table */ 1:
    ...
    internalBinaryWrite(message: UpdateAllTypeTableReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* example.AllTypeTable all_type_table = 1; */
...
/**
 * @generated MessageType for protobuf message example.UpdateAllTypeTableReq
 */
...
class ListAllTypeTablesReq$Type extends MessageType<ListAllTypeTablesReq> {
    constructor() {
        super("example.ListAllTypeTablesReq", [
            { no: 1, name: "page", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 2, name: "page_size", kind: "scalar", localName: "page_size", T: 5 /*ScalarType.INT32*/ },
            { no: 3, name: "order_by_field", kind: "enum", localName: "order_by_field", T: () => ["example.AllTypeTableField", AllTypeTableField] },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int32 page_size */ 2:
                    ...
                    break;
                case /* example.AllTypeTableField order_by_field */ 3:
                    message.order_by_field = reader.int32();
                    break;
                case /* bool order_by_desc */ 4:
                    message.order_by_desc = reader.bool();
                    break;
                case /* repeated example.AllTypeTableFilter filters */ 5:
    ...
    internalBinaryWrite(message: ListAllTypeTablesReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* example.AllTypeTableField order_by_field = 3; */
        ...
        /* repeated example.AllTypeTableFilter filters = 5; */
...
/**
 * @generated MessageType for protobuf message example.ListAllTypeTablesReq
 */
...
class AllTypeTableFilter$Type extends MessageType<AllTypeTableFilter> {
    constructor() {
        super("example.AllTypeTableFilter", [
            { no: 1, name: "field", kind: "enum", T: () => ["example.AllTypeTableField", AllTypeTableField] },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: AllTypeTableFilter): AllTypeTableFilter {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* example.AllTypeTableField field */ 1:
    ...
    internalBinaryWrite(message: AllTypeTableFilter, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* example.AllTypeTableField field = 1; */
        if (message.field !== 0)
...
/**
 * @generated MessageType for protobuf message example.AllTypeTableFilter
 */
...
class ListAllTypeTablesResp$Type extends MessageType<ListAllTypeTablesResp> {
    constructor() {
        super("example.ListAllTypeTablesResp", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ListAllTypeTablesResp): ListAllTypeTablesResp {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated example.AllTypeTable all_type_tables */ 1:
    ...
    internalBinaryWrite(message: ListAllTypeTablesResp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated example.AllTypeTable all_type_tables = 1; */
...
/**
 * @generated MessageType for protobuf message example.ListAllTypeTablesResp
 */
export const ListAllTypeTablesResp = new ListAllTypeTablesResp$Type();
/**
 * @generated ServiceType for protobuf service example.AllTypeTableService
 */
export const AllTypeTableService = new ServiceType("example.AllTypeTableService", [
