...
export interface IUserServiceClient {
    /**
     * @generated from protobuf rpc: CreateUser(User) returns (User);
     */
    createUser(input: User, options?: RpcOptions): UnaryCall<User, User>;
    /**
     * @generated from protobuf rpc: DeleteUser(UserId) returns (google.protobuf.Empty);
     */
    deleteUser(input: UserId, options?: RpcOptions): UnaryCall<UserId, Empty>;
    /**
     * @generated from protobuf rpc: UpdateUser(UpdateUserReq) returns (User);
     */
    updateUser(input: UpdateUserReq, options?: RpcOptions): UnaryCall<UpdateUserReq, User>;
    /**
     * @generated from protobuf rpc: GetUser(UserId) returns (User);
     */
    getUser(input: UserId, options?: RpcOptions): UnaryCall<UserId, User>;
    /**
     * @generated from protobuf rpc: ListUsers(ListUsersReq) returns (ListUsersResp);
     */
