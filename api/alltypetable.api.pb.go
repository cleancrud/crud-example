...
type ListAllTypeTablesReq struct {
	...
	// default 20
	PageSize int32 `protobuf:"varint,2,opt,name=page_size,json=pageSize,proto3" json:"page_size,omitempty" form:"page_size"` // @gotags: form:"page_size"
	// order by field
	OrderByField AllTypeTableField `protobuf:"varint,3,opt,name=order_by_field,json=orderByField,proto3,enum=example.AllTypeTableField" json:"order_by_field,omitempty" form:"order_by_field"` // @gotags: form:"order_by_field"
	// ASC DESC
	OrderByDesc bool `protobuf:"varint,4,opt,name=order_by_desc,json=orderByDesc,proto3" json:"order_by_desc,omitempty" form:"order_by_desc"` //@gotags: form:"order_by_desc"
	// filter
	Filters []*AllTypeTableFilter `protobuf:"bytes,5,rep,name=filters,proto3" json:"filters,omitempty" form:"filters"` //@gotags: form:"filters"
}
...
type AllTypeTableFilter struct {
	...
	Field AllTypeTableField `protobuf:"varint,1,opt,name=field,proto3,enum=example.AllTypeTableField" json:"field,omitempty"`
...
type ListAllTypeTablesResp struct {
	...
	TotalCount    int32           `protobuf:"varint,2,opt,name=total_count,json=totalCount,proto3" json:"total_count"`           // @gotags: json:"total_count"
	PageCount     int32           `protobuf:"varint,3,opt,name=page_count,json=pageCount,proto3" json:"page_count"`              // @gotags: json:"page_count"
}
...
var file_proto_alltypetable_api_proto_rawDesc = []byte{
	...
	0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4d, 0x61, 0x73, 0x6b, 0x22, 0xe4, 0x01, 0x0a, 0x14, 0x4c,
	...
	,
	...
	,
...
var file_proto_alltypetable_api_proto_goTypes = []interface{}{
	(AllTypeTableField)(0),        // 0: example.AllTypeTableField
	(*AllTypeTable)(nil),          // 1: example.AllTypeTable
	(*AllTypeTableId)(nil),        // 2: example.AllTypeTableId
	(*UpdateAllTypeTableReq)(nil), // 3: example.UpdateAllTypeTableReq
	(*ListAllTypeTablesReq)(nil),  // 4: example.ListAllTypeTablesReq
	(*AllTypeTableFilter)(nil),    // 5: example.AllTypeTableFilter
	(*ListAllTypeTablesResp)(nil), // 6: example.ListAllTypeTablesResp
	(*emptypb.Empty)(nil),         // 7: google.protobuf.Empty
}
var file_proto_alltypetable_api_proto_depIdxs = []int32{
	1,  // 0: example.UpdateAllTypeTableReq.all_type_table:type_name -> example.AllTypeTable
	0,  // 1: example.ListAllTypeTablesReq.order_by_field:type_name -> example.AllTypeTableField
	5,  // 2: example.ListAllTypeTablesReq.filters:type_name -> example.AllTypeTableFilter
	0,  // 3: example.AllTypeTableFilter.field:type_name -> example.AllTypeTableField
	1,  // 4: example.ListAllTypeTablesResp.all_type_tables:type_name -> example.AllTypeTable
	1,  // 5: example.AllTypeTableService.CreateAllTypeTable:input_type -> example.AllTypeTable
	2,  // 6: example.AllTypeTableService.DeleteAllTypeTable:input_type -> example.AllTypeTableId
	3,  // 7: example.AllTypeTableService.UpdateAllTypeTable:input_type -> example.UpdateAllTypeTableReq
	2,  // 8: example.AllTypeTableService.GetAllTypeTable:input_type -> example.AllTypeTableId
	4,  // 9: example.AllTypeTableService.ListAllTypeTables:input_type -> example.ListAllTypeTablesReq
	1,  // 10: example.AllTypeTableService.CreateAllTypeTable:output_type -> example.AllTypeTable
	7,  // 11: example.AllTypeTableService.DeleteAllTypeTable:output_type -> google.protobuf.Empty
	1,  // 12: example.AllTypeTableService.UpdateAllTypeTable:output_type -> example.AllTypeTable
	1,  // 13: example.AllTypeTableService.GetAllTypeTable:output_type -> example.AllTypeTable
	6,  // 14: example.AllTypeTableService.ListAllTypeTables:output_type -> example.ListAllTypeTablesResp
